...
// Expose store globally for AviFlow bridge integration
(window as any).__aviflow_store = store;
(window as any).__aviflow_api = {
  loadText: (text: string) => {
    store.currentCanvas.loadFromText(text);
  },
  getText: () => {
