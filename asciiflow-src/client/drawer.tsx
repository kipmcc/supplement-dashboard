...
import {
  ...
  Download, Share2, FileText, MoreHorizontal, Trash2, Plus, Pencil,
  Square, MousePointer2, PenTool, ArrowUpRight, Minus, Type, Eraser,
  Sun, Moon, Keyboard,
} from "lucide-react";
    ...
    <ControlledDialog
      button={
        menu ? (
          ...
          <Button color="primary" startIcon={<Pencil size={20} />}>
            Fork & edit
          </Button>
        )
      }
